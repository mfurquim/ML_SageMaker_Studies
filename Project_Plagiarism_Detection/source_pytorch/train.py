...
if __name__ == '__main__':
    ...
    ## Add args for the three model parameters: input_features, hidden_dim, output_dim
    # Model Parameters
    parser.add_argument('--input_features', type=int, default=3, metavar='N',
                        help='size of the word embeddings (default: 3)')
    parser.add_argument('--hidden_dim', type=int, default=16, metavar='N',
                        help='size of the hidden dimension (default: 16)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='N',
                        help='size of the vocabulary (default: 1)')
    ...
    ## Complete in the model_info by adding three argument names, the first is given
